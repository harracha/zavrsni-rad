...
import { create, createMany, deleteExam, list, updateExam } from '../controllers/exam-controller';
...
examRouter.post('/createMany', sessionUserExists, userHasRole(['ADMIN', 'PROFESSOR']), async (req: Request, res: Response, next: Function) => {
...
examRouter.post('/create', sessionUserExists, userHasRole(['ADMIN', 'PROFESSOR']), async(req:Request, res:Response, next:Function) => {
...
examRouter.put('/update/:examId', sessionUserExists, userHasRole(['ADMIN', 'PROFESSOR']), async(req: Request, res: Response, next: Function) => {
...
examRouter.delete('/delete/:examId', sessionUserExists, userHasRole(['ADMIN', 'PROFESSOR']), async(req:Request, res:Response, next:Function) => {
    const examId = req.params.examId;
...
examRouter.get('/get', sessionUserExists, userHasRole(['ADMIN', 'PROFESSOR']), async(req:Request<any, any, any, examFilterParams>, res:Response, next:Function) => {
