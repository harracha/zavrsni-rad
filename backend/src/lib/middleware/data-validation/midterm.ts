...
export const midtermPointsValidation = (req:Request, res:Response, next: Function) => {

    const midtermData: Prisma.MidtermCreateInput[] = Array.isArray(req.body) ? req.body : Array.from(req.body)
