...
export const examPointsValidation = (req: Request, res:Response, next:Function) => {

    const examData: Prisma.ExamUncheckedCreateInput[] =  Array.isArray(req.body) ? req.body : Array.from(req.body)
