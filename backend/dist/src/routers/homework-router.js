...
homeworkRouter.post(
  ...
  homework_1.homeworkPointsValidation,
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const homeworkData = req.body
      try {
        const homework = yield (0,
        homework_controller_1.filterExistingHomeworks)(homeworkData)
...
homeworkRouter.get(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _a, _b
      const queryParams = (0,
      homework_query_parser_1.parseHomeworkFilterParams)(req.url)
      if (
        ((_a = req.session.user) === null || _a === void 0
          ? void 0
          : _a.role) === 'STUDENT'
      ) {
        const student = yield (0, student_controller_1.getStudent)(
          (_b = req.session.user) === null || _b === void 0 ? void 0 : _b.email,
        )
        queryParams.studentId = [student.studentId]
      }
      try {
        const homework = yield (0, homework_controller_1.listHomeworks)(
          queryParams,
        )
        res.status(200).send(homework)
      } catch (error) {
...
homeworkRouter.put(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        const updatedHomeworks = yield (0,
        homework_controller_1.updateHomeworks)(updateData)
...
homeworkRouter.put(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const updateData = req.body
      try {
        const updatedHomework = yield (0, homework_controller_1.updateHomework)(
          homeworkId,
          updateData,
        )
...
homeworkRouter.delete(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        const deletedHomeworks = yield (0,
        homework_controller_1.deleteHomework)(deleteData)
