...
labExerciseRouter.post(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        const labs = yield (0, labExercise_controller_1.createLabExercises)(
          exerciseData,
        )
...
labExerciseRouter.get(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _a, _b
      const params = (0,
      labExercise_query_parser_1.parseLabExerciseFilterParams)(req.url)
      if (
...
labExerciseRouter.put(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        const updatedLabs = yield (0,
        labExercise_controller_1.updateLabExercises)(updateData)
...
labExerciseRouter.delete(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      labExercise_query_parser_1.parseLabExerciseFilterParams)(req.url)
      try {
        const deletedLabs = yield (0,
        labExercise_controller_1.deleteLabExercises)(params)
        return deletedLabs
      } catch (error) {
        res.status(500).send({
          message:
