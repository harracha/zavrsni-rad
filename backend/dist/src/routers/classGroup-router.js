...
classGroupRouter.get(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const params = (0, classGroup_query_parser_1.parseClassGroupFilterParams)(
        req.url,
      )
      try {
        ...
        if (
          ((_b =
            assistant === null || assistant === void 0
              ? void 0
              : assistant.classGroup) === null || _b === void 0
            ? void 0
            : _b.groupId) !== id
        ) {
          res.status(403).send({
...
classGroupRouter.post(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        const newClassGroup = yield (0,
        classGroup_controller_1.createClassGroup)(classGroupInfo)
...
classGroupRouter.put(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        const updatedGroup = yield (0,
        classGroup_controller_1.updateClassGroup)(id, updateInfo)
...
classGroupRouter.delete(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const id = req.params.classGroupId
      try {
        const deletedGroup = yield (0,
        classGroup_controller_1.deleteClassGroup)(id)
