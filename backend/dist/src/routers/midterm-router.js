...
midtermRouter.post(
  ...
  midterm_1.midtermPointsValidation,
...
midtermRouter.put(
  ...
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        const updatedMidterm = yield (0, midterm_controller_1.updateMidterm)(
          midtermId,
          updateData,
        )
...
midtermRouter.delete(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const midtermId = req.params.midtermId
      try {
        const deletedMidterm = yield (0, midterm_controller_1.deleteMidterm)(
          midtermId,
        )
...
midtermRouter.get(
  ...
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const filter = (0, midterm_query_parser_1.parseMidtermFilterParams)(
        req.url,
      )
      try {
