...
exports.filterExistingHomeworks = exports.deleteHomework = exports.updateHomework = exports.updateHomeworks = exports.listHomeworks = exports.getBatchHomeworks = exports.listStudentHomeworks = exports.createHomework = void 0;
const client_1 = require("@prisma/client");
const prisma_1 = __importDefault(require("../lib/prisma"));
const createHomework = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const listStudentHomeworks = (student) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getBatchHomeworks = (studentIds) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const homeworks = yield prisma_1.default.homework.findMany({
            where: {
...
const listHomeworks = (queryParams) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const homeworks = yield prisma_1.default.homework.findMany({
            where: {
...
const updateHomeworks = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateHomework = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const deleteHomework = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const filterExistingHomeworks = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        homeworksCopy.map((homework) => {
            const studentHomeworks = homeworks.filter(prismaHomework => prismaHomework.studentId === homework.studentId);
            const existingHomework = studentHomeworks.find(studentHomework => studentHomework.acYear === homework.acYear &&
