...
exports.deleteLabExercises = exports.updateLabExercises = exports.getLabExercises = exports.createLabExercises = void 0;
const prisma_1 = __importDefault(require("../lib/prisma"));
const createLabExercises = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getLabExercises = (params) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateLabExercises = (updateData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const deleteLabExercises = (deleteParams) => __awaiter(void 0, void 0, void 0, function* () {
    try {
