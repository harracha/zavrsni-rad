...
exports.getStudent =
  ...
  exports.list =
  exports.listStudentsByLabGroup =
  exports.listStudentsByClassGroup =
    void 0
const prisma_1 = __importDefault(require('../lib/prisma'))
const listStudentsByClassGroup = classGroupId =>
...
const listStudentsByLabGroup = labGroupId =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const students = yield prisma_1.default.student.findMany({
        where: {
