...
exports.deletelabGroup = exports.updatelabGroup = exports.createlabGroup = exports.getlabGroup = exports.list = void 0;
...
exports.list = list;
const getlabGroup = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const createlabGroup = (info) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updatelabGroup = (id, updateInfo) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const deletelabGroup = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
