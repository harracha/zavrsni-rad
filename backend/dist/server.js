...
const teacher_router_1 = __importDefault(
  require('./src/routers/teacher-router'),
)
const student_router_1 = __importDefault(
  require('./src/routers/student-router'),
)
const cors_1 = __importDefault(require('cors'))
const midterm_router_1 = __importDefault(
  require('./src/routers/midterm-router'),
)
const labGroup_router_1 = __importDefault(
  require('./src/routers/labGroup-router'),
)
const labExercise_router_1 = __importDefault(
  require('./src/routers/labExercise-router'),
)
const homework_router_1 = __importDefault(
  require('./src/routers/homework-router'),
)
const exam_router_1 = __importDefault(require('./src/routers/exam-router'))
const classGroup_router_1 = __importDefault(
  require('./src/routers/classGroup-router'),
)
